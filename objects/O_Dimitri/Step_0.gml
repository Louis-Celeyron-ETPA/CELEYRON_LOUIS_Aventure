...
if(dirX >= 1){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
	...
	/// @DnDHash : 1C6B1299
	/// @DnDParent : 3FC62E8D
	/// @DnDArgument : "spriteind" "S_Vitefait_R"
	/// @DnDSaveInfo : "spriteind" "S_Vitefait_R"
	sprite_index = S_Vitefait_R;
	image_index = 0;
...
if(dirX <= -1){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
	...
	/// @DnDHash : 57DAED90
	/// @DnDParent : 3D8B409C
	/// @DnDArgument : "spriteind" "S_Vitefait_L"
	/// @DnDSaveInfo : "spriteind" "S_Vitefait_L"
	sprite_index = S_Vitefait_L;
	image_index = 0;
...
if(dirY >= 1){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
	...
	/// @DnDHash : 4FC155A0
	/// @DnDParent : 718A320D
	/// @DnDArgument : "spriteind" "S_Vitefait_D"
	/// @DnDSaveInfo : "spriteind" "S_Vitefait_D"
	sprite_index = S_Vitefait_D;
	image_index = 0;
...
if(dirY <= -1){	/// @DnDAction : YoYo Games.Instances.Set_Sprite
	...
	/// @DnDHash : 33974EF0
	/// @DnDParent : 136E006D
	/// @DnDArgument : "spriteind" "S_Vitefait_U"
	/// @DnDSaveInfo : "spriteind" "S_Vitefait_U"
	sprite_index = S_Vitefait_U;
	image_index = 0;
...
var l4456CC8D_0;l4456CC8D_0 = keyboard_check_pressed(vk_space);if (l4456CC8D_0){	/// @DnDAction : YoYo Games.Instances.If_Instance_Exists
	...
	/// @DnDHash : 7C0AEAA2
	/// @DnDParent : 4456CC8D
	/// @DnDArgument : "obj" "O_Champi"
	/// @DnDArgument : "not" "1"
	/// @DnDSaveInfo : "obj" "O_Champi"
	var l7C0AEAA2_0 = false;l7C0AEAA2_0 = instance_exists(O_Champi);if(!l7C0AEAA2_0){	/// @DnDAction : YoYo Games.Instances.Create_Instance
		/// @DnDVersion : 1
		/// @DnDHash : 402A6CF3
		/// @DnDParent : 7C0AEAA2
